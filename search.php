  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active"  style="font-size: 2rem; margin-left: 2rem; color: var(--black);"aria-current="page" href="#">Home</a>
        </li>
        <li class="nav-item">
          <a class="nav-link"  style="font-size: 2rem; margin-left: 2rem; color: var(--black);"href="#">Shop</a>
        </li>
        <li class="nav-item">
    ...
    <div class="bg-info p-3 text-center">
        <p>Created by Tshiamo Monageng</p>
    </div>
